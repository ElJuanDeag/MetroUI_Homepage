...
export const tileRows: TileRow[] = [
  {
    ...
    groups: [
      ...
      /* New group 1 */
      {
        ...
        columns: 3,
        tiles: [
          { id: "alpha", title: "Alpha", slug: "/alpha", color: "#1ABC9C", size: "2x1" },
          { id: "beta", title: "Beta", slug: "/beta", color: "#2980B9", size: "1x1" },
          { id: "gamma", title: "Gamma", slug: "/gamma", color: "#7F8C8D", size: "1x1" },
          { id: "delta", title: "Delta", slug: "/delta", color: "#C0392B", size: "2x2" },
        ],
      },
      ...
      /* New group 2 */
      {
        ...
        columns: 3,
        tiles: [
          { id: "one", title: "One", slug: "/one", color: "#16A085", size: "1x1" },
          { id: "two", title: "Two", slug: "/two", color: "#27AE60", size: "1x1" },
          { id: "three", title: "Three", slug: "/three", color: "#F39C12", size: "2x1" },
          { id: "four", title: "Four", slug: "/four", color: "#8E44AD", size: "1x1" },
          { id: "five", title: "Five", slug: "/five", color: "#34495E", size: "1x1" },
        ],
      },
    ],
  },
